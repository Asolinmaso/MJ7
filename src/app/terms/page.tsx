        ...
        <div className="space-y-12 text-[#DBDADA] text-lg lg:text-[20px] font-light leading-relaxed">
          <section>
            ...
            <p>
              ...
              terms you wish to establish between your business and your customers and visitors. We 
          ...
          <section>
            <h2 className="text-2xl md:text-3xl font-medium text-white mb-4">Terms & Conditions - the basics</h2>
            <p className="mb-4">
              ...
              activities of the website visitors, or your customers, while they visit or engage with 
              this website. The T&C are meant to establish the legal relationship between the site 
              visitors and you as the website owner.
            </p>
            <p className="mb-4">
              T&C should be defined according to the specific needs and nature of each website. For 
              example, a website offering products to customers in e-commerce transactions requires T&C 
              that are different from the T&C of a website only providing information (like a blog, a 
          ...
          <section>
            <h2 className="text-2xl md:text-3xl font-medium text-white mb-4">What to include in the T&C document</h2>
            <p>
              ...
              his or her offering in the future; the types of warranties the website owner gives his or 
              her customers; a reference to issues of intellectual property or copyrights, where 
