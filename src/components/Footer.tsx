      ...
      <div className="max-w-[1230px] mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-[50px] items-start">
          ...
          <div className="flex flex-col gap-4 max-w-[331px]">
            ...
            <p className="text-[#DBDADA] text-lg lg:text-[24px] font-light leading-relaxed lg:leading-[36px]">
          ...
          <div className="flex flex-col gap-6 max-w-[205px]">
            <h4 className="text-[#FB270C] text-[24px] font-bold leading-[36px] tracking-[0.01em]">
              Quick Links
            </h4>
            <ul className="flex flex-col gap-3 text-[#DBDADA] text-lg lg:text-[24px] font-light leading-[36px] tracking-[0.01em]">
          ...
          <div className="flex flex-col gap-6 max-w-[367px]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-[#DBDADA] text-lg lg:text-[24px] font-light leading-snug">
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-[#DBDADA] text-lg lg:text-[24px] font-light leading-none">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-[#DBDADA] text-lg lg:text-[24px] font-light leading-tight">
